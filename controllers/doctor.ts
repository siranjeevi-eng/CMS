...
module.exports.addDoctor = async(req:Request<{},{}, AddDoctorBody>,res:Response)=>{
...
module.exports.showDoctor = async(req:Request<DoctorParams>,res:Response)=>{
    try{
        const {id} = req.params;
...
module.exports.editDoctor = async(req:Request<DoctorParams, {}, AddDoctorBody>,res:Response)=>{
    try{
        const {id} = req.params;
        const {name, email, specialization,experience} = req.body
...
module.exports.deleteDoctor = async(req:Request<DoctorParams>,res:Response)=>{
    const {id} = req.params
    try{
